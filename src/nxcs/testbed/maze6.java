 ...
 * in Mazes/Woods1.txt
 */
public class maze6 implements Environment {
	/**
	 ...
	 */
	public maze6(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public maze6(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				maze6 maze = new maze6("data/maze6.txt");
				// maze.resetPosition();
...
//				 }
	...
	public HashMap<Point, Result> GetResult(maze6 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(maze6 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
