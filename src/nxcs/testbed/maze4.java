 ...
 * in Mazes/Woods1.txt
 */
public class maze4 implements Environment {
	/**
	 ...
	 */
	public maze4(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public maze4(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				maze4 maze = new maze4("data/maze4.txt");
				// maze.resetPosition();
...
//						}
					...
					if (maze.isEndOfProblem(maze.getState())) {
						...
						if (finalStateCount == 1 || finalStateCount == 2 || finalStateCount == 3|| finalStateCount == 40|| finalStateCount == 50
...
//				}
	...
	public HashMap<Point, Result> GetResult(maze4 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(maze4 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
