 ...
 * in Mazes/Woods1.txt
 */
public class DSTF_TraceReset_small implements Environment {
	/**
	 ...
	 */
	public DSTF_TraceReset_small(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DSTF_TraceReset_small(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DSTF_TraceReset_small maze = new DSTF_TraceReset_small("data/DSThalf3bit.txt");
				maze.resetPosition();
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(DSTF_TraceReset_small maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DSTF_TraceReset_small maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
