 ...
 * in Mazes/Woods1.txt
 */
public class twoF_reset implements Environment {
	/**
	 ...
	 */
	public twoF_reset(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public twoF_reset(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				twoF_reset maze = new twoF_reset("data/twoF.txt");
				maze.resetPosition();
				...
				int i = 1;
				while (finalStateCount < 301) {
					nxcs.runIteration(i, maze.getState());
					i++;

					if (finalStateCount % 300 == 0 && !logged) {
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(twoF_reset maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(twoF_reset maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
