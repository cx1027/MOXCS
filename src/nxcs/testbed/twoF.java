 ...
 * in Mazes/Woods1.txt
 */
public class twoF implements Environment {
	/**
	 ...
	 */
	public twoF(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public twoF(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				twoF maze = new twoF("data/twoF.txt");
				maze.resetPosition();
				...
				int i = 1;
				while (finalStateCount < 201) {
					nxcs.runIteration(i, maze.getState());
					i++;

					if (finalStateCount % 200 == 0 && !logged) {
...
//						}
	...
	public HashMap<Point, Result> GetResult(twoF maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(twoF maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
