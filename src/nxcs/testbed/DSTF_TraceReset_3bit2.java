 ...
 * in Mazes/Woods1.txt
 */
public class DSTF_TraceReset_3bit2 implements Environment {
	/**
	 ...
	 */
	public DSTF_TraceReset_3bit2(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DSTF_TraceReset_3bit2(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DSTF_TraceReset_3bit2 maze = new DSTF_TraceReset_3bit2("data/DSTF3bit.txt");
				maze.resetPosition();
...
//				params.pHash = 0.5;
				...
				while (finalStateCount < 1501) {
					...
					if (finalStateCount % 1500 == 0 && !logged) {
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(DSTF_TraceReset_3bit2 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DSTF_TraceReset_3bit2 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
