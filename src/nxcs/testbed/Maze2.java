 ...
 * in Mazes/Woods1.txt
 */
public class Maze2 implements Environment {
	/**
	...
	public ArrayList<Reward> getRewardGrid() {
		return rewardGrid;
	}
	 ...
	 */
	public Maze2(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public M(File f) throws IOException {
