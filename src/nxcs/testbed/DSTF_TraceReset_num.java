 ...
 * in Mazes/Woods1.txt
 */
public class DSTF_TraceReset_num implements Environment {
	/**
	 ...
	 */
	public DSTF_TraceReset_num(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DSTF_TraceReset_num(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DSTF_TraceReset_num maze = new DSTF_TraceReset_num("data/DST3bit.txt");
				maze.resetPosition();
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(DSTF_TraceReset_num maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DSTF_TraceReset_num maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
