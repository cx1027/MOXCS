 ...
 * in Mazes/Woods1.txt
 */
public class maze5 implements Environment {
	/**
	 ...
	 */
	public maze5(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public maze5(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				maze5 maze = new maze5("data/maze5.txt");
				// maze.resetPosition();
...
//				 }
	...
	public HashMap<Point, Result> GetResult(maze5 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(maze5 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
