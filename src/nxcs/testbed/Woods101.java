 ...
 * in Mazes/Woods1.txt
 */
public class Woods101 implements Environment {
	/**
	 ...
	 */
	public Woods101(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public Woods101(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				Woods101 maze = new Woods101("data/woods101.txt");
				maze.resetPosition();
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(Woods101 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(Woods101 maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
