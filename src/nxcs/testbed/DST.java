 ...
 * in Mazes/Woods1.txt
 */
public class DST implements Environment {
	/**
	 ...
	 */
	public DST(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DST(File f) throws IOException {
	...
	public HashMap<Point, Result> GetResult(DST maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DST maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
