 ...
 * in Mazes/Woods1.txt
 */
public class DSTF_TraceReset_Full_num implements Environment {
	/**
	 ...
	 */
	public DSTF_TraceReset_Full_num(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DSTF_TraceReset_Full_num(File f) throws IOException {
...
//		}
		...
		finalStates.add(new Point(5, 5));
		finalStates.add(new Point(6, 5));
		finalStates.add(new Point(7, 8));
		finalStates.add(new Point(8, 8));
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DSTF_TraceReset_Full_num maze = new DSTF_TraceReset_Full_num("data/DSTF3bit.txt");
				maze.resetPosition();
...
//				params.pHash = 0.5;
				...
				int i = 1;
				while (finalStateCount < 1201) {
					nxcs.runIteration(i, maze.getState());
					i++;

					if (finalStateCount % 1200 == 0 && !logged) {
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(DSTF_TraceReset_Full_num maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DSTF_TraceReset_Full_num maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
