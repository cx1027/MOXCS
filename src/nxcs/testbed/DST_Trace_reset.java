 ...
 * in Mazes/Woods1.txt
 */
public class DST_Trace_reset implements Environment {
	/**
	 ...
	 */
	public DST_Trace_reset(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DST_Trace_reset(File f) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DST_Trace_reset maze = new DST_Trace_reset("data/DST.txt");
				maze.resetPosition();
...
//					maze.y=1;
	...
	public HashMap<Point, Result> GetResult(DST_Trace_reset maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DST_Trace_reset maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
