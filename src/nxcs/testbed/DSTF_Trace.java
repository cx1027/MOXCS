 ...
 * in Mazes/Woods1.txt
 */
public class DSTF_Trace implements Environment {
	/**
	 ...
	 */
	public DSTF_Trace(String mazeFile) throws IOException {
	 ...
	 *             On standard IO problems
	 */
	public DSTF_Trace(File f) throws IOException {
		// Set up the encoding table FOR DST
		encodingTable = new HashMap<Character, String>();
		encodingTable.put('O', "0000");
		encodingTable.put('T', "1100");
		encodingTable.put(null, "1101");// For out of the maze positions
		encodingTable.put('F', "1111");
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int z = 0; z < totalCalcTimes; z++) {
				...
				DSTF_Trace maze = new DSTF_Trace("data/DSTF.txt");
				maze.resetPosition();
...
//				params.pHash = 0.5;
	...
	public HashMap<Point, Result> GetResult(DSTF_Trace maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
	...
	public HashMap<Point, Result> trace(DSTF_Trace maze, NXCS nxcs) {
		int finalStateCount2 = 0;
		int timestamp = 0;
		HashMap<Point, Result> resultMap = new HashMap<Point, Result>();
