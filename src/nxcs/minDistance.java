...
public class minDistance {
	...
	public double getCoreDistance(ArrayList<Qvector> qSet1, ArrayList<Qvector> qSet2) {
	...
	public double getMINDistance(ArrayList<Qvector> qSet1, ArrayList<Qvector> qSet2) {
		double dis = 0;
		double min = 0;
		int flag = 0;
	...
	public double getMAXDistance(ArrayList<Qvector> qSet1, ArrayList<Qvector> qSet2) {
		double dis = 0;
		double max = 0;
		int flag = 0;
	...
	public double getJDistance(ArrayList<Qvector> qSet1, ArrayList<Qvector> qSet2) {
